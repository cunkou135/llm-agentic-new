...
CORE_ANALYSIS_FILES = [
    ...
    "mechanism_bidirectional_summary.csv",
    "path_timing_summary.csv",
    "path_timing_concordance.csv",
...
def generate_tables(run_root: Path) -> list[Path]:
    ...
    secondary_sources = {
        ...
        "mechanism_bidirectional_summary.csv": "mechanism_bidirectional_summary_source.csv",
        ...
        "path_timing_concordance.csv": "path_timing_concordance_source.csv",
